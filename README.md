...
2. Download and extract **Source code (zip)** from [release 0.1.5](https://github.com/60plus/steamos-nvidia-installer/releases/tag/v0.1.5), or clone tag `v0.1.5`. Open the extracted repository folder and run:
