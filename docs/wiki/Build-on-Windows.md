...
Download the source archive for [release 0.1.6](https://github.com/60plus/steamos-nvidia-installer/releases/tag/v0.1.6), or clone tag `v0.1.6`, inside Linux. Keep the full
